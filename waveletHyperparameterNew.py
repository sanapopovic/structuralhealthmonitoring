...
import preprocess
# Replaced the old wavelet_processing import with your new SST module functions
from transforms.sst_processing import reconstruct_band_cwt 
...
for val in test_range:
    ...
    # Reconstruct Base using the new SST function flavor
    ...
    # Reconstruct Harmonic using the new SST function flavor
    recon_h = reconstruct_band_cwt(
        t, signal, band_min_harmonic, band_max_harmonic,
        wavelet=current_wavelet, fmin=f_min_analyse, fmax=f_max_analyse, n_freqs=n_freqs
    )
    
    # Rest of the pipeline remains completely untouched
